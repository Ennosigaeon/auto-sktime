...
from pytorch_forecasting import TimeSeriesDataSet, MultiLoss, DeepAR, \
...
def evaluate_deepar(
    ...
    logger = TensorBoardLogger(f"deepar/{name}/{seed}/")
    ...
    deepar = DeepAR.from_dataset(
        training,
        MultiLoss([MultivariateNormalDistributionLoss()] * len(y.columns))
    )
    ...
    predictions = best_deepar.predict(test_dataloader)
