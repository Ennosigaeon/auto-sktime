...
def print_raw_performance():
    autorul = {
        ...
        'femto_bearing': [26.973312, 27.396291, 28.83302, 14.529346, 21.113618, 12.366536, 22.175948, 19.347928,
                          26.087229, 26.389449],
        'filtration': [4.97182, 5.101947, 6.522199, 6.799997, 5.759050, 5.114282, 6.792338, 5.266525, 5.165513,
                       6.990814],
        'phm08': [26.6776846821459, 26.5677479286446, 27.6308342255532, 29.8473734187784, 29.5025851409669,
    ...
    random_forest = {
        ...
        'filtration': [6.427489, 5.574944, 6.955994, 7.228762, 6.305010, 5.943331, 7.449933, 6.893373, 6.246812,
                       7.870088],
        'phm08': [31.2410556799862, 31.139835741378, 30.4387481674263, 31.1912734590943, 30.6047774048432,
    ...
    lstm = {
        ...
        'cmapss_2': [17.766856, 18.411374, 16.634752, 17.413341, 19.367612, 17.504524, 18.053524, 18.098999, 17.968152,
                     18.563029],
        'cmapss_3': [11.765872, 12.145545, 11.972510, 12.236323, 11.701966, 11.676044, 11.796663, 11.083439, 11.425196,
                     11.787479],
        ...
        'filtration': [5.545543, 5.693300, 6.997323, 7.183846, 5.843927, 6.034569, 7.196829, 6.357253, 5.390593,
                       6.954364],
        'phm08': [29.0272928465608, 28.9718209645165, 27.8433088910065, 27.5929329720492, 28.2991393862075,
    ...
    cnn = {
        'cmapss': [17.729213, 16.880596, 16.124352, 15.996100, 16.970271, 17.615540, 17.599030, 15.871664, 16.977988,
                   16.800957],
        'cmapss_2': [23.089831, 23.742979, 23.059695, 23.370648, 23.680346, 23.755606, 23.960246, 23.644329, 23.991244,
                     23.369883],
        ...
        'filtration': [14.846346, 15.259048, 15.637210, 15.423385, 14.842429, 12.992488, 15.865576, 15.181291,
                       14.143920, 15.784535],
        'phm08': [31.8637395796539, 31.2967496714914, 31.3157188964264, 31.7201670865713, 30.8540238866829,
    ...
    transformers = {
        ...
        'filtration': [6.150689, 7.518467, 6.987488, 7.040194, 6.523790, 7.100308, 7.391409, 6.517309, 7.351363,
                       7.128781],
        'phm08': [30.1522053919776, 29.9894071298517, 30.4635752990354, 29.167937019954, 30.1972975612057,
    ...
    svm = {
        ...
        'filtration': [8.615825, 8.395696, 9.049813, 9.845869, 9.50282, 8.663529, 9.547853, 8.468463, 7.823363,
                       10.124959],
        'phm08': [44.7784334250317, 46.1944087525752, 46.1944087525752, 46.1944087525752, 45.6838242707416,
                  34.157903916956, 31.645400929677, 33.0865259584623, 35.1994147678623, 43.4222857528251],
    }
    print('Nieto2015\n', pd.DataFrame(svm).describe())

    autocoevorul = {
        'cmapss': [16.259029433148285, 14.839146727405224, 14.782005913316578, 15.587311011260736, 14.574158361153689,
                   15.504548956605554, 15.500938333856695, 15.62067105928699, 16.703988056775746, 16.67932951694009],
        'cmapss_2': [18.540305556341014, 16.79569806173818, 18.293760922174776, 16.61590882038273, 18.70850061150374,
                     18.399885213850972, 16.683376026628256, 16.18120818010116, 18.736131843067934, 18.92463186765048],
        'cmapss_3': [16.16792967838529, 15.437392290060638, 16.12887429502924, 15.125943678212986, 14.829162058571958,
                     16.19167973117422, 13.999458002206236, 16.50542177378143, 16.809375367523824, 15.011441352716783],
        'cmapss_4': [16.938912794800117, 17.967638284895678, 16.603693429809105, 15.506281718098252, 15.741299378638873,
                     16.817718076636464, 16.643901157032094, 15.83155859288426, 14.69420236616984, 16.63209241013984],
        'phme20': [14.635979284249483, 16.02044229666742, 16.398019864653072, 15.193066260438986, 11.044510529891704,
                   13.635713786418487, 18.92627219772393, 18.868193702728215, 12.753430935608408, 14.822842886594522],
        'femto_bearing': [37.2491796984193, 24.41982910253519, 32.64477679769104, 27.561730709031558, 40.98508925090833,
        ...
        'filtration': [10.987414467922517, 10.771928376792468, 11.398574867015204, 11.369101980371754,
                       ...
                       11.183602782536962],
        'phm08': [45.18158142, 48.12007897, 46.54629416, 45.54495911, 45.97452773, 47.96650706, 44.7264452, 46.81558715,
